                    ...
                    <div class="card-body">
                        ...
                        <form action="/questionnaires/{{ $questionnaire->id }}/questions" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <small id="questionHelp" class="form-text text-muted">Ask a simple and to-the-point question</small>
                            ...
                            <div class="form-group">
                                <fieldset>
                                    ...
                                    <small id="choicesHelp" class="form-text text-muted">Give choices that gives most insight to your question</small>
